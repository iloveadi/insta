  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ── 2. MAIN CENTER CONTENT (Clean High-Impact Typography) ── */}
        <div className="relative z-10 my-auto py-8 flex flex-col justify-center w-full flex-1">
          ...
          {/* B. CONTENT SLIDE */}
          {slide.type === 'content' && (
            <div className="space-y-8 my-auto flex flex-col justify-center">
              {/* Step / Number Badge */}
              {slide.step_or_num && (
                <div>
              ...
              {/* Title */}
              <h2 className="text-5xl sm:text-6xl font-black leading-[1.28] tracking-tight break-keep">
          ...
          {slide.type === 'checklist' && (
            <div className="space-y-8 my-auto flex flex-col justify-center">
              {slide.step_or_num && (
                <div>
                  <span className="px-7 py-3 rounded-2xl bg-gradient-to-r from-emerald-500 to-teal-600 text-white font-black text-2xl tracking-wider shadow-lg shadow-emerald-500/30 inline-block">
                    {slide.step_or_num}
                  </span>
                </div>
              )}
          ...
          {slide.type === 'comparison' && (
            <div className="space-y-8 my-auto flex flex-col justify-center">
              {slide.step_or_num && (
                <div>
                  <span className="px-7 py-3 rounded-2xl bg-gradient-to-r from-rose-500 to-amber-500 text-white font-black text-2xl tracking-wider shadow-lg shadow-rose-500/30 inline-block">
                    {slide.step_or_num}
                  </span>
                </div>
              )}
          ...
          {/* E. CTA SLIDE */}
          {slide.type === 'cta' && (
            <div className="space-y-10 text-center max-w-[940px] mx-auto my-auto flex flex-col items-center justify-center">
